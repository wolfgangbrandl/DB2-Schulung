...
DBPATH		=	/data1/$(DB2INSTANCE)/metadata/$(DATASOURCE)
TABLEPATH	=	/data1/$(DB2INSTANCE)/tablespaces/$(DATASOURCE)
STOGRFIRST	=	/data1/$(DB2INSTANCE)/tablespaces/$(DATASOURCE)/FIRST
STOGRPSECOND	=	/data1/$(DB2INSTANCE)/tablespaces/$(DATASOURCE)/SECOND
DBLOGPATH	=	/logs1/$(DB2INSTANCE)/log/$(DATASOURCE)
DBARCHIVELOG	=	/logs1/$(DB2INSTANCE)/archive/$(DATASOURCE)
BACKUPDIR       =       /data1/backup/$(DB2INSTANCE)
CFLAGS 		= 	-g -w 
